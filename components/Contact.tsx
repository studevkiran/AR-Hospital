  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="inline-block mt-4 px-6 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-full text-sm font-medium hover:shadow-lg hover:shadow-emerald-500/50 transition-all"
                >
                  Get Directions
                </a>
              </div>
        ...
        >
          <h3 className="text-3xl font-bold text-white text-center mb-8">Connect With Us</h3>
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
            {/* Phone */}
            <a href="tel:9008994827" className="group" title="Call Us">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <Phone className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" />
            ...
            <a href="mailto:info@arhospital.com" className="group" title="Email">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <Mail className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" />
            ...
            <a href="https://www.facebook.com/arhospitalmysuru/" target="_blank" rel="noopener noreferrer" className="group" title="Facebook">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <Facebook className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" />
            ...
            <a href="https://youtube.com/@arhospital-j2m?si=4BhkpkoF4txsKrmU" target="_blank" rel="noopener noreferrer" className="group" title="YouTube">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <Youtube className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" />
            ...
            <a href="https://maps.google.com/?q=22+New+Kantharaj+Urs+Rd+CFTRI+layout+Sharadadevi+Nagar+Mysuru+Karnataka+570022" target="_blank" rel="noopener noreferrer" className="group" title="Location">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <MapPin className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" />
                <p className="text-white font-semibold text-sm">Maps</p>
              </div>
            </a>
            ...
            <a href="https://www.justdial.com/Mysore/A-R-Hospital-Opposite-Nivedita-Nagar-Arch-Sharadadevi-Nagar/0821PX821-X821-220629111932-Q8K5_BZDET" target="_blank" rel="noopener noreferrer" className="group" title="JustDial">
              <div className="glass-effect rounded-2xl p-6 border-2 border-emerald-500/20 flex flex-col items-center justify-center h-full hover:bg-emerald-500/10 transition-all">
                <svg className="w-10 h-10 text-emerald-400 mb-3 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M9 11l3 3L22 4"/>
                  <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
                </svg>
                <p className="text-white font-semibold text-sm">JustDial</p>
              </div>
            </a>
          </div>
        </motion.div>
