...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-black via-emerald-950/40 to-black relative overflow-hidden border-t border-emerald-500/20">
      {/* Background Effects */}
      <div className="absolute top-0 left-1/4 w-[300px] h-[300px] bg-emerald-500/10 rounded-full blur-3xl z-0" />
      <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-teal-500/10 rounded-full blur-3xl z-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-12">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">AR Hospital</h3>
                  <p className="text-emerald-400 text-sm">Healing Hands</p>
                </div>
              </div>
            ...
            >
              <h4 className="text-xl font-bold text-white mb-6 flex items-center justify-end gap-2">
              ...
              <ul className="space-y-3 mb-8">
                {quickLinks.map((link, index) => (
                  <li key={index} className="flex justify-end">
                    ...
                    >
                      {link.name}
                      <span className="w-1 h-1 rounded-full bg-emerald-400 group-hover:w-2 transition-all" />
                    </a>
                  </li>
                ))}
              </ul>
