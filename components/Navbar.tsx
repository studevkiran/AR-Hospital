...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#008B8B] to-[#00CED1] backdrop-blur-xl border-b border-orange-200/30 shadow-lg">
        <div className="hidden lg:flex items-center h-20 gap-0 relative">
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex items-center gap-3 px-6 pr-6 border-r border-orange-300/20 bg-teal-900/50"
          >
            ...
            <div>
              ...
              <p className="text-[#FFA726] text-xs font-medium whitespace-nowrap">Healing Hands</p>
            </div>
          </motion.div>

          <div ref={defaultRef} className="w-[120px] h-20 border-r border-orange-300/20 flex items-center justify-center" />
          ...
          {navLinks.map((link) => (
            <button
              ...
              className="w-[120px] h-20 border-r border-orange-300/20 flex items-center justify-center relative group transition-all duration-300 hover:bg-orange-500/10"
            >
              <span className={`font-medium transition-all duration-300 ${
                activeSection === link.section 
                  ? 'text-[#FFA726] text-lg' 
                  : 'text-white group-hover:text-[#FFA726]'
              }`}>
                {link.name}
              </span>
            </button>
        ...
        <div className="w-[180px] h-20 border-r border-orange-300/20 flex items-center justify-center flex-shrink-0 relative overflow-hidden bg-[#006666]/50">
          <div className="relative z-10 text-center">
            <div className="text-[#FFA726] text-sm font-mono font-bold tracking-wider drop-shadow-[0_0_8px_rgba(255,167,38,0.6)]">
              {currentTime}
            </div>
            <div className="text-orange-100 text-xs mt-0.5">Live Time</div>
          </div>
          ...
          <motion.div
            className="absolute right-4 top-1/2 -translate-y-1/2 w-2 h-2 bg-[#FFA726] rounded-full shadow-[0_0_8px_rgba(255,167,38,0.8)]"
            animate={{
              scale: [1, 1.8, 1],
              opacity: [1, 0.4, 1]
            }}
        ...
        <div className="ml-auto px-6 flex-shrink-0">
          <a
            ...
            className="px-6 py-3 bg-gradient-to-r from-[#FF6B35] to-[#FF7F50] text-white rounded-full font-medium shadow-lg hover:shadow-orange-500/50 hover:scale-105 transition-all whitespace-nowrap inline-flex items-center gap-2"
          >
            <span>📱</span>
        ...
        >
          <div className="relative w-28 h-20 flex items-center justify-center">
            <Image
              ...
              width={112}
              height={80}
              className="object-contain drop-shadow-[0_0_15px_rgba(255,127,80,0.6)] brightness-110"
              priority
            />
          </div>
        </motion.div>
      ...
      {/* Mobile Navigation */}
      <div className="lg:hidden bg-gradient-to-r from-[#008B8B] to-[#00CED1] backdrop-blur-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#FFA726] text-xs whitespace-nowrap">Healing Hands</p>
              </div>
            </div>
            ...
            <button
              ...
              className="p-2 text-white hover:text-[#FFA726] transition-colors"
          ...
          {isMobileMenuOpen && (
            ...
            >
              {navLinks.map((link) => (
                <a
                  ...
                  className={`py-3 px-4 rounded-lg text-center font-medium transition-all ${
                    activeSection === link.section
                      ? 'bg-orange-500/20 text-[#FFA726] border border-orange-500/30'
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 py-3 px-4 bg-gradient-to-r from-[#FF6B35] to-[#FF7F50] text-white rounded-lg text-center font-medium shadow-lg hover:shadow-orange-500/50 transition-all"
              >
                📱 Book Appointment
              </a>
            </motion.div>
