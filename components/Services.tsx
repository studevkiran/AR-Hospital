...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-b from-black via-emerald-950/30 to-black relative overflow-hidden">
      {/* Background Pattern with emerald glow */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-300 border-2 border-emerald-500/20 h-full relative overflow-hidden group-hover:border-emerald-400/40">
                  ...
                  {/* Medical Plus Corner */}
                  <div className="absolute bottom-6 right-6 text-emerald-400/30 group-hover:text-emerald-400/60 transition-all duration-300 text-5xl font-bold">
                    +
                  </div>
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-12 border-2 border-emerald-500/20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-emerald-400 font-medium">
                <span className="bg-white/5 px-6 py-3 rounded-full border border-emerald-500/30">Emergency Services</span>
                <span className="bg-white/5 px-6 py-3 rounded-full border border-emerald-500/30">ICU Care</span>
                <span className="bg-white/5 px-6 py-3 rounded-full border border-emerald-500/30">Pharmacy</span>
                <span className="bg-white/5 px-6 py-3 rounded-full border border-emerald-500/30">Laboratory</span>
              </div>
            </div>
          </div>
        </motion.div>
